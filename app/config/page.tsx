              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormState(prev => ({ ...prev, selectedDriver: e.target.value }))}
                    className="bg-zinc-800 border border-zinc-700 text-white w-full p-2 rounded"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormState(prev => ({ ...prev, selectedRace: e.target.value }))}
                    className="bg-zinc-800 border border-zinc-700 text-white w-full p-2 rounded"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setFormState(prev => ({ ...prev, powerPlant: e.target.value }))}
                    className="bg-zinc-800 border border-zinc-700 text-white w-full p-2 rounded"
                  >
                      ...
                      {fields.map((field) => (
                        <div key={field}>
                          ...
                          {field === 'inputType' ? (
                            <select
                              value={channel[field]}
                              onChange={(e) => updateChannel(index, field, e.target.value)}
                              className="bg-zinc-800 border border-zinc-700 text-white w-full p-2 rounded"
                            >
